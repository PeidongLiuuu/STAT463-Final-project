...
```{r}
#| fig.cap = "Outlier Dection",
#| fig.subcap = c("Univariate outlier detection for Co-variate", "Univariate outlier detection for Response","Multivariate Boxplot Outlier Dection"),
#| fig.ncol = 2,
#| out.width = "50%",
#| fig.pos = "H",
#| fig.show = "hold"
